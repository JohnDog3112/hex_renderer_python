...
class ModuleTestTwo:
	class ModuleTest:
		hello = ModuleTestTwo.ModuleTest.ItemOne | ModuleTestTwo.ModuleTest.ItemTwo | ModuleTestTwo.ModuleTest.ItemThree
		class ItemThree(object):
			def test(self) -> None:
				...
			...
		class ItemTwo(object):
			...
		class ItemOne(object):
			...
		...
	...
class EndPoint:
